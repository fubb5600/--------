<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSd005Q1.aspx.cs" Inherits="TDOSd005_TDOSd005Q1" %>
                        ...
                        <ContentTemplate>
                            <table width="100%" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">
                                ...
                                <td width="10%" class="td_head">
                                    ...
                                    <td class="td_cont"width="10%" >
                                     <asp:RadioButtonList ID="work_type" runat="server" RepeatDirection="Horizontal" >
                                        </asp:RadioButtonList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="td_cont" width="20%" colspan="5" >
                                ...
                                <tr>
                                    <td class="td_head"  >
                                        保管單位<br /> ( <input id="chkAllunit" type="checkbox" /><label for="chkAllunit">全選</label> )&nbsp;
                                    </td>
                        ...
                        <td>
                            <asp:Panel ID="buttonPanel" runat="server">
                                <asp:Button ID="btnQuery" runat="server" Text="產出報表" CssClass="btn_grey" OnClick="btnQuery_Click" OnClientClick=" GetNotifyMsg();"
                                    ValidationGroup="save" Width="108px" />
                                <asp:Button ID="btnQuery1" runat="server" CssClass="btn_grey" OnClick="btnQuery1_Click" OnClientClick=" GetNotifyMsg();" Text="產出報表1" ValidationGroup="save" Width="108px" />
                                <asp:Button ID="btnQuery2" runat="server" CssClass="btn_grey" OnClick="btnQuery2_Click" OnClientClick=" GetNotifyMsg();" Text="產出報表2" ValidationGroup="save" Width="108px" />
                            </asp:Panel>
                        </td>
                    </tr>
                </table>
