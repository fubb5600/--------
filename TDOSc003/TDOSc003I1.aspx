<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSc003I1.aspx.cs" Inherits="TDTSc003_TDTSc003I1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
                                ...
                                <td>
                                        ...
                                        <table width="700px" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_cont">
                                                    ...
                                                    <asp:DropDownList ID="card_id" runat="server" AutoPostBack="true" OnSelectedIndexChanged="card_id_SelectedIndexChanged" style="height: 17px">
                                                    </asp:DropDownList>
                                                    <asp:Button ID="btnReloadCarId" runat="server" Text="更新" 
                                                        onclick="btnReloadCarId_Click" />
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" CssClass="td_must"
                                                        ErrorMessage="加油卡必填" ControlToValidate="card_id" ValidationGroup="save" InitialValue=""
                                 ...
                                 <asp:DropDownList ID="location" runat="server" AutoPostBack="true" >
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_cont">
                                                    ...
                                                    <asp:ImageButton ID="ibUpdate" runat="server" ImageUrl="~/images/update.png" AlternateText="更新統計資訊"
                                                        OnClick="ibUpdate_Click" CausesValidation="True" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_cont">
                                                    <asp:TextBox ID="work_date" runat="server" CssClass="date" Width="60px" OnTextChanged="work_date_TextChanged"
                                            ...
                                            <asp:Panel ID="pnlMileage" runat="server">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td_cont">
                                                        <asp:TextBox ID="car_count" runat="server" Width="80px" Text="1"     IsReadOnly="True"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_cont">
                                                    <asp:TextBox ID="work_man" runat="server" MaxLength="50" Width="220px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_cont">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" CssClass="td_must"
                                                        ...
                                                        Display="Dynamic" Text="必填"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_head">
                                                ...
                                                <td class="td_cont">
                                                    ...
                                                    <asp:TextBox ID="selected_item" runat="server" TextMode="MultiLine" Rows="3" Width="400px"
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        //            if (document.getElementById("MasterPage_ContentPlaceHolder1_work_start").value != "" && document.getElementById("MasterPage_ContentPlaceHolder1_work_end").value != "" &&
        //            document.getElementById("MasterPage_ContentPlaceHolder1_work_date").value != "") {
