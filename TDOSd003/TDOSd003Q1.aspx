<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSd003Q1.aspx.cs" Inherits="TDOSd003_TDOSd003Q1" %>
                        ...
                        <ContentTemplate>
                            <table width="100%" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    ...
                                    <td class="td_cont" width="25%" colspan="3">
                                ...
                                <tr>
                                    <td class="td_head">
                                        保管單位(<input id="chkAllunit" type="checkbox" /><label for="chkAllunit">全選</label> )&nbsp;
                                    </td>
