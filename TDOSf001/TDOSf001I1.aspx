<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSf001I1.aspx.cs" Inherits="TDTSf001_TDTSf001I1" %>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="38%" class="td_cont">
                                        <div id="div_K">
                                            ...
                                            <asp:Button ID="btnToilet" runat="server" Text="確定" CssClass="btn_grey" OnClientClick="getNotifyItemValue();"
                                                OnClick="btnCar_Click" ValidationGroup="car" /><span class="td_memo">(或局編號)</span>
                                ...
                                <tr>
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:Label ID="work_no_advise" runat="server" Text="" CssClass="td_must"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td class="td_cont" colspan="3">
                                        <table style="width: 440px; line-height: 180%" id="notify_table">
                                            <tr>
                                                <td width="410px">
...
<%--                                        <input id="notify_item" type="hidden" runat="server" />--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_head">
                                    ...
                                    <td class="td_cont">
                                       ...
                                       <asp:Label ID="Label1" runat="server" Text="必塡" Visible="False" BorderColor="Red" ForeColor="#CC0000"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:TextBox ID="driver" runat="server" Width="60px"></asp:TextBox>
                                        <span class="td_memo">(自行輸入請設「請選擇」)</span>
    ...
    <script type="text/javascript">
        ...
        function getKeyType() {
            ...
            var table = document.getElementById('<%=key_type.ClientID%>');
            for (i = 0; i < table.rows[0].cells.length; i++)
                if (table.rows[0].cells[i].children[0].checked == true)
                    selValue = table.rows[0].cells[i].children[0].value;
