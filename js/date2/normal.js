...
var giDatePos=2;	// date format sequence  0: D-M-Y ; 1: M-D-Y; 2: Y-M-D 3: 民國Y-M-D
...
var gBegin=[1912,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
// ---- 民國年 ----
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >今天是 : 民國"+parseInt(gToday[0]-1911)+"年"+gToday[1]+"月"+gToday[2]+"日</A>";	// the content of the bottom section.
