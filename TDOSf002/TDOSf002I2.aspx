<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSf002I2.aspx.cs" Inherits="TDTSe002_TDTSe002I2" %>
                            ...
                            <table width="100%" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">                               
                                <tr style="height:55px">
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="TEST.xls" Font-Size="Small">範例檔案下載</asp:HyperLink>
                                    </td>
                                </tr>
                                <tr style="height:55px">
                                    <td class="td_head">
