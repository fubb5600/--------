<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSf002I1.aspx.cs" Inherits="TDTSf002_TDTSf002I1" %>
                                    ...
                                    <td class="td_cont">
                                     ...
                                     <%--   <asp:RadioButtonList ID="time_unit" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" CssClass="td_must"
                                            runat="server" 
                                            ControlToValidate="delivery_days" ValidationGroup="save" Display="Dynamic"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:CheckBox ID="check_result1" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" Text="合格" OnCheckedChanged="check_result1_SelectedIndexChanged"></asp:CheckBox><!--下拉選單改checkBox-->
                                        <asp:CheckBox ID="check_result2" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" Text="不合格" OnCheckedChanged="check_result2_SelectedIndexChanged"></asp:CheckBox><!--下拉選單改checkBox-->
                    ...
                    <tr>
                        <td>
                            <asp:Panel ID="buttonPanel" runat="server">
                                <asp:Button ID="btnSave" runat="server" Text="儲存" CssClass="btn_grey" OnClick="btnSave_Click" OnClientClick=" workNo()"
