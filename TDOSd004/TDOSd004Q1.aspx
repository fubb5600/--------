<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSd004Q1.aspx.cs" Inherits="TDOSd004_TDOSd004Q1" %>
                            ...
                            <table width="100%" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td width="10%" class="td_head">
                                        <span class="td_must">*</span>報表日期
                                    </td>
                                    <td class="td_cont" >
                                        <asp:TextBox ID="report_date" runat="server" size="10" CssClass="date"></asp:TextBox>                                        
                                        <asp:Button ID="btnBefore" runat="server" Text="前一日" CssClass="Button" 
                                            onclick="btnBefore_Click" />
                                        <asp:Button ID="btnToday" runat="server" Text="今日" CssClass="Button" 
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="td_must"
                                            ErrorMessage="報表日期必填" ControlToValidate="report_date" ValidationGroup="save" Display="Dynamic">
                                        </asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="無效日期" CssClass="td_must"
                                            ClientValidationFunction="Date_Validate" ControlToValidate="report_date" ValidationGroup="save"
                                            Display="Dynamic" OnServerValidate="DateValidator_ServerValidate"></asp:CustomValidator>                                       
                                    </td>                                   
                                </tr>                                
                                <tr>
                                    <td class="td_head">
                                        單位(<input id="chkAllunit" type="checkbox" /><label for="chkAllunit">全選</label> )&nbsp;
                                    </td>
                                    <td class="td_cont">
                                        <asp:CheckBoxList ID="crs_org" runat="server" RepeatDirection="Horizontal" RepeatColumns="7"
