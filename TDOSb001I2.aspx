<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TDOSb001I2.aspx.cs" Inherits="TDTSb001_TDTSb001I2" %>
                            ...
                            <table width="100%" class="table_sn table_border" border="0" cellpadding="0" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" CssClass="td_must"
                                            ...
                                            ControlToValidate="fuel_count" ValidationGroup="cal" Display="Dynamic"></asp:RegularExpressionValidator>
                                    </td>
                                    <td class="td_head">
                                    ...
                                    <td class="td_cont">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" CssClass="td_must"
                                            runat="server" ErrorMessage="整數" ValidationExpression="^[0-9]*$" ControlToValidate="fuel_amount"
                                ...
                                <tr>
                                    ...
                                    <div style="float:left;">
                                        ...
                                        <span class="td_memo">(交易日期後60天內)</span>
                                        </div>
                                    </td>
                                </tr>                                
                                <tr>
